...
int main(){
    ...
    AlgoritmoGeneracionalCrucePosicion(n, m, semilla, probabilidad_mutacion, probabilidad_cruce, poblacion, matriz_datos);
    ...
    tiempos.push_back(make_pair("Generacional", mejor_sol.dispersion));
    ...
    MuestraVector("Distancias", mejor_sol.distancias);

    r = {"Generacional", mejor_sol.dispersion, time_span.count()};
