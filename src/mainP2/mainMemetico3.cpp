...
int main(){
    ...
    AlgoritmoMemeticoVariante3(n, m, semilla, probabilidad_mutacion, probabilidad_cruce, poblacion, matriz_datos);
    ...
    tiempos.push_back(make_pair("memetico3", mejor_sol.dispersion));
    ...
    r = {"memetico3", mejor_sol.dispersion, time_span.count()};
