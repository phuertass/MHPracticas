...
int main(){
    ...
    //cout<<"\n\n\n\nALGORITMO MEMETICO VARIANTE1"<<endl;
    poblacion = poblacion_auxiliar;
    t1 = chrono::high_resolution_clock::now();
    AlgoritmoMemeticoVariante1(n, m, semilla, probabilidad_mutacion, probabilidad_cruce, poblacion, matriz_datos);
    ...
    MuestraVector("\nULTSEL DISTANCIAS", mejor_sol.distancias);
    cout<<endl;


    tiempos.push_back(make_pair("memetico1", mejor_sol.dispersion));

    r = {"memetico1", mejor_sol.dispersion, time_span.count()};
