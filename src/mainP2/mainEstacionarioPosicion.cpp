...
int main(){
    ...
    AlgoritmoEstacionarioCrucePosicion(n, m, semilla, probabilidad_mutacion, probabilidad_cruce, poblacion, matriz_datos);
    ...
    tiempos.push_back(make_pair("Estacionario", mejor_sol.dispersion));
    ...
    r = {"Estacionario", mejor_sol.dispersion, time_span.count()};
